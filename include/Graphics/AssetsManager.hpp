...
class AssetsManager {
 public:
   ...
   * SpriteSheet cannot be overridden.
   ...
   * @as SpriteSheet
   */
  static SpriteSheet &createSpriteSheet(const std::string &name, const std::string &uri, unsigned int tile_w,
                                        unsigned int tile_h, unsigned int margin = 0);
   ...
   */
  static Animation &createAnimation(const std::string &name, const std::string &spriteSheetName);
  /**
   * @brief Create a new animation and return it.
   * @details Name is unique, if you try to create a new animation
   * with an existing name, the method return the existing animation.
   ...
   * @as Animation SpriteSheet
   */
  static Animation &createAnimation(const std::string &name, const SpriteSheet &spriteSheet);
   ...
   */
  static TileMap &createTileMap(const std::string &name, unsigned tile_width, unsigned tile_height, unsigned width,
                                unsigned height);
