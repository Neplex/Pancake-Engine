...
void CreatePrefabAndSpriteAndInput() {
  ...
  PancakeEngine::InputManager::createButton("player2_fire",
                                            std::vector<sf::Keyboard::Key>({sf::Keyboard::Key::RControl}));
  PancakeEngine::InputManager::createButton("player2_right",
                                            std::vector<sf::Keyboard::Key>({sf::Keyboard::Key::Right}));
  ...
  PancakeEngine::InputManager::createButton("ShowDebugInfo", std::vector<sf::Keyboard::Key>({sf::Keyboard::Key::F1}),
                                            PancakeEngine::Debug::switchEnableDebugGUI);
};
